...
namespace OnlineShop.Db.Migrations
{
    public partial class Initialization : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProductProductCompare",
                columns: table => new
                {
                    ProductComparesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductsId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductProductCompare", x => new { x.ProductComparesId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_ProductProductCompare_ProductCompares_ProductComparesId",
                        column: x => x.ProductComparesId,
                        principalTable: "ProductCompares",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductProductCompare_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductProductCompare_ProductsId",
                table: "ProductProductCompare",
                column: "ProductsId");
        }
